...
<!-- Conversation output only — $analyze never writes this to disk. Use this shape when presenting results. -->
...
[If any CRITICAL finding exists: "Resolve CRITICAL findings before $implement." Otherwise: "No CRITICAL findings — ready for $implement." Zero findings overall is valid — report it as such, don't invent issues to fill the report.]
